...
var fetchTodos = exports.fetchTodos = function fetchTodos() {
  return function (dispatch) {
    return (0, _todo_api_util.getTodos)().then(function (todos) {
...
var TodoForm = function (_React$Component) {
  ...
  _createClass(TodoForm, [{
    ...
    value: function addToDo() {
      ...
      return function () {
        var newTodo = Object.assign({}, _this3.state);
        newTodo['id'] = _this3.uniqueID();
        console.log(newTodo);
        _this3.props.createTodo(newTodo);
...
exports.postTodo = exports.getTodos = undefined;
